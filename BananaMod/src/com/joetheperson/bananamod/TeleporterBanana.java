...
public class TeleporterBanana extends Teleporter {
    ...
    public TeleporterBanana(WorldServer par1WorldServer) {
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
            ...
            for (k1 = l - short1; k1 <= l + short1; ++k1) {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
                    ...
                    for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
                        if (this.worldServerInstance.getBlockId(k1, i2, l1) == BananaMod.blockPortalBanana.blockID) {
                            while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == BananaMod.blockPortalBanana.blockID) {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D) {
            ...
            if (this.worldServerInstance.getBlockId(i - 1, j, k) == BananaMod.blockPortalBanana.blockID) {
                j2 = 2;
            }
            ...
            if (this.worldServerInstance.getBlockId(i, j, k - 1) == BananaMod.blockPortalBanana.blockID) {
                j2 = 3;
            }
        ...
        for (k2 = 0; k2 < 4; ++k2) {
            for (i3 = 0; i3 < 4; ++i3) {
                for (l2 = -1; l2 < 4; ++l2) {
                    ...
                    this.worldServerInstance.setBlock(k3, j3, i4, flag ? Block.obsidian.blockID : BananaMod.blockPortalBanana.blockID, 0, 2);
                }
            }
